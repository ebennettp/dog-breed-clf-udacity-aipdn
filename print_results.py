...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if print_incorrect_dogs:
        ...
        for i_clf_dog in results_stats_dic['incorrect_dog']:
            print(f"    Image name: {i_clf_dog}")
            print(f"        True is_dog value: {results_dic[i_clf_dog][3]}")
            print(f"        Classifier is_dog value: {results_dic[i_clf_dog][4]}")

    if print_incorrect_breed:
        print(f"\nIncorrectly classified breeds: ({len(results_stats_dic['incorrect_breed'])} found)")
        results_stats_dic['incorrect_breed']
        for i_clf_dog in results_stats_dic['incorrect_breed']:
            print(f"    Image name: {i_clf_dog}")
            print(f"        True breed value: {results_dic[i_clf_dog][0]}")
            print(f"        Classifier breed value: {results_dic[i_clf_dog][1]}")
